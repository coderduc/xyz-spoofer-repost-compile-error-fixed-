...
int APIENTRY main(HINSTANCE, HINSTANCE, LPSTR, int)
{
    ...
    WNDCLASSEX wc = { sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, L"CoderDuc", NULL };
    RegisterClassEx(&wc);
    main_hwnd = CreateWindow(wc.lpszClassName, L"CoderDuc", WS_POPUP, 0, 0, 5, 5, NULL, NULL, wc.hInstance, NULL);
